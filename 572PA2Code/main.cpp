...
int main(int argc, char **argv)
{
    ...
    for (uint32_t i = 0; i < numVertices; ++i) {
        ...
        float focalLength = cos(angleOfView * PI / 360) / sin(angleOfView * PI / 360);
        projectedVert.y = -focalLength * vertCamera.y / vertCamera.z;
        projectedVert.x = -focalLength * vertCamera.x / vertCamera.z;
